...
export default function SingleRecipe() {
  const sample = {
    ...
    extendedIngredients: [
      {
        ...
        measures: {
          ...
          metric: { amount: 8.0, unitShort: "servings", unitLong: "servings" },
        },
      },
      {
        id: 11124,
    ...
    spoonacularScore: 99.42807006835938,
    spoonacularSourceUrl:
      "https://spoonacular.com/red-lentil-soup-with-chicken-and-turnips-715415",
  };
  const [singleRecipe, setSingleRecipe] = useState(sample);
  return (
    <div className="single-recipe-wrapper bg-white">
      <div
      ...
      <div className="container py-4 ">
        <div className="row justify-content-center">
          ...
          <div className="col-sm-12 col-md-7">
            <h1 className="display-6 my-3 fw-bold">{singleRecipe.title}</h1>
            <p className="text-muted">
              Ready in {singleRecipe.readyInMinutes} minutes | Servings:{" "}
              {singleRecipe.servings}
            </p>
            <p dangerouslySetInnerHTML={{ __html: singleRecipe.summary }}></p>
          </div>
        </div>
      </div>
    </div>
